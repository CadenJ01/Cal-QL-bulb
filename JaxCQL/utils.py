...
class WandBLogger(object):
    ...
    def get_default_config(updates=None):
        ...
        config.project = 'sac'
        config.output_dir = os.path.join(tempfile.gettempdir(), 'Cal-QL')
    ...
    def __init__(self, config, variant):
        ...
        self._wandb_mode = 'online' if self.config.online else 'offline'
        ...
        try:
            ...
            logging.warning('No wandb_config.py found, falling back to offline logging.')
            os.environ["WANDB_MODE"] = "disabled"
            self._wandb_mode = 'disabled'
